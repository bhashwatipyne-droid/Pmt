...
import { ArrowLeft, Building2, User as UserIcon, Calendar } from "lucide-react";
    ...
    <div data-testid="project-detail-page" className="flex-1 overflow-auto px-8 py-6">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
          <h2 className="mb-4 text-base font-bold text-slate-900">Deliverables <span className="text-slate-400 font-medium">({project.deliverables?.length || 0})</span></h2>
